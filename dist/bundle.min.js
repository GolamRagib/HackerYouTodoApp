...
var TodoList=_react2.default.createClass({displayName:"TodoList",render:function render(){var _this=this;return _react2.default.createElement("div",{className:"row mytag top-buffer"},this.props.todos.map(function(todo,i){if(todo.completed&&[0,1].includes(_this.props.selector))return _this.createList(todo,i);else if(!todo.completed&&[0,2].includes(_this.props.selector))return _this.createList(todo,i);}));},createList:function createList(todo,i){var _this2=this;return _react2.default.createElement("div",{className:"col-xs-12 half-buffer",key:i},_react2.default.createElement("div",{className:""},_react2.default.createElement("div",{className:"input-group"},_react2.default.createElement("span",{className:"input-group-addon"},_react2.default.createElement("input",{type:"checkbox",checked:todo.completed,onChange:function onChange(){return _this2.props.onComplete(i);}})),_react2.default.createElement("input",{type:"text",className:"form-control",onChange:function onChange(evt){return _this2.props.onUpdateText(i,evt.target.value);},value:todo.text}),_react2.default.createElement("span",{className:"input-group-btn"},_react2.default.createElement("button",{type:"button",className:"btn btn-primary",onClick:function onClick(){return _this2.props.onDelete(i);}},_react2.default.createElement("span",{className:"glyphicon glyphicon-remove"}))))));}});exports.default=TodoList;},function(module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _react=__webpack_require__(1);var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
var TodoNew=_react2.default.createClass({displayName:"TodoNew",getInitialState:function getInitialState(){return{newTodo:""};},render:function render(){return _react2.default.createElement("div",{className:"row"},_react2.default.createElement("div",{className:"col-xs-12"},_react2.default.createElement("hr",null),_react2.default.createElement("div",{className:"input-group"},_react2.default.createElement("input",{type:"text",className:"form-control",placeholder:"Add Something New",value:this.state.newTodo,onChange:this.updateNewTodo}),_react2.default.createElement("span",{className:"input-group-btn"},_react2.default.createElement("button",{type:"button",className:"btn btn-primary",value:this.state.newTodo,onClick:this.onAddNewButtonClick},_react2.default.createElement("span",{className:"glyphicon glyphicon-plus"}))))));},updateNewTodo:function updateNewTodo(evt){this.setState({newTodo:evt.target.value});},onAddNewButtonClick:function onAddNewButtonClick(evt){this.props.onAddNewButtonClick(this.state.newTodo);this.setState({newTodo:""});}});exports.default=TodoNew;},function(module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _react=__webpack_require__(1);var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
var TodoSelector=_react2.default.createClass({displayName:"TodoSelector",getInitialState:function getInitialState(){return{selectors:["All","Complete","Incomplete"]};},render:function render(){var _this=this;return _react2.default.createElement("div",{className:"row mytag"},_react2.default.createElement("div",{className:"col-xs-12"},_react2.default.createElement("ul",{className:"nav nav-tabs"},this.state.selectors.map(function(selectors,i){if(i==_this.props.selector)return _react2.default.createElement("li",{role:"presentation",className:"active",key:i},_react2.default.createElement("a",{onClick:function onClick(evt){return _this.props.onUpdateSelector(i);}},selectors));else return _react2.default.createElement("li",{role:"presentation",key:i},_react2.default.createElement("a",{onClick:function onClick(evt){return _this.props.onUpdateSelector(i);}},selectors));}))));}});exports.default=TodoSelector;}]);
...
var TodoApp=_react2.default.createClass({displayName:'TodoApp',getInitialState:function getInitialState(){return{todos:[{text:"Learn arrow functions",completed:false},{text:"Learn Javascript arrays",completed:true},{text:"Learn JSX",completed:false},{text:"Learn Typescript",completed:false}],selector:0};},render:function render(){var _this=this;return _react2.default.createElement('div',{className:'todo-list'},_react2.default.createElement(_todo_header2.default,{todos:this.state.todos,selector:this.state.selector,columns:this.state.columns}),_react2.default.createElement(_todo_selector2.default,{todos:this.state.todos,selector:this.state.selector,onUpdateSelector:function onUpdateSelector(i){return _this.setState({selector:i});},columns:this.state.columns}),_react2.default.createElement(_todo_list2.default,{todos:this.state.todos,selector:this.state.selector,onDelete:function onDelete(i){return _this.deleteTodo(i);},onComplete:function onComplete(i){return _this.toggleComplete(i);},onUpdateText:function onUpdateText(i,newText){return _this.updateTodoText(i,newText);},columns:this.state.columns}),_react2.default.createElement(_todo_new2.default,{onAddNewButtonClick:function onAddNewButtonClick(newTodo){return _this.addNewTodo(newTodo);},columns:this.state.columns}));},updateTodoText:function updateTodoText(i,newText){var todoItems=this.state.todos;todoItems[i].text=newText;this.setState({todos:todoItems});},addNewTodo:function addNewTodo(newTodo){if(!newTodo)return;var todos=this.state.todos;var newTodoItem={text:newTodo,completed:false};this.setState({todos:todos.concat([newTodoItem])});},toggleComplete:function toggleComplete(i){var todoItems=this.state.todos;todoItems[i].completed=!todoItems[i].completed;this.setState({todos:todoItems});},deleteTodo:function deleteTodo(i){var todoItems=this.state.todos;todoItems.splice(i,1);this.setState({todos:todoItems});}});exports.default=TodoApp;},function(module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _react=__webpack_require__(1);var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
var TodoHeader=_react2.default.createClass({displayName:"TodoHeader",render:function render(){return _react2.default.createElement("div",{className:"row"},_react2.default.createElement("header",{className:"todo-header"},_react2.default.createElement("h2",null,this.headerMessages())));},headerMessages:function headerMessages(){var k=this.props.selector;var itemCounts=[0,0,0];var headerMessage=["in the list","completed","incomplete"];itemCounts[0]=this.props.todos.length;for(var j=0;j<itemCounts[0];j++){if(this.props.todos[j].completed)itemCounts[1]++;else itemCounts[2]++;}
var message=itemCounts[k]?itemCounts[k]+" ":"No ";message+=[0,1].includes(itemCounts[k])?"task ":"tasks ";message+=headerMessage[k];return message;}});exports.default=TodoHeader;},function(module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _react=__webpack_require__(1);var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
var TodoList=_react2.default.createClass({displayName:"TodoList",render:function render(){var _this=this;return _react2.default.createElement("div",{className:"row"},this.props.todos.map(function(todo,i){if(todo.completed&&[0,1].includes(_this.props.selector))return _this.createList(todo,i);else if(!todo.completed&&[0,2].includes(_this.props.selector))return _this.createList(todo,i);}));},createList:function createList(todo,i){var _this2=this;return _react2.default.createElement("div",{className:"bottom-buffer",key:i},_react2.default.createElement("div",{className:"input-group"},_react2.default.createElement("span",{className:"input-group-btn"},_react2.default.createElement("button",{type:"button",className:todo.completed?"btn btn-success":"btn btn-warning",onClick:function onClick(){return _this2.props.onComplete(i);}},_react2.default.createElement("span",{className:todo.completed?"glyphicon glyphicon-ok":"glyphicon glyphicon-ok-none"}))),_react2.default.createElement("input",{type:"text",className:"form-control",onChange:function onChange(evt){return _this2.props.onUpdateText(i,evt.target.value);},value:todo.text}),_react2.default.createElement("span",{className:"input-group-btn"},_react2.default.createElement("button",{type:"button",className:"btn btn-danger",onClick:function onClick(){return _this2.props.onDelete(i);}},_react2.default.createElement("span",{className:"glyphicon glyphicon-trash"})))));}});exports.default=TodoList;},function(module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _react=__webpack_require__(1);var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
var TodoNew=_react2.default.createClass({displayName:"TodoNew",getInitialState:function getInitialState(){return{newTodo:""};},render:function render(){return _react2.default.createElement("div",{className:"row"},_react2.default.createElement("div",{className:"bottom-buffer"},_react2.default.createElement("div",{className:"input-group"},_react2.default.createElement("span",{className:"input-group-btn"},_react2.default.createElement("button",{type:"button",className:"btn",disabled:"true"},_react2.default.createElement("span",{className:"glyphicon glyphicon-ok-none"}))),_react2.default.createElement("input",{type:"text",className:"form-control",placeholder:"Add Something New",value:this.state.newTodo,onKeyPress:this.onPressEnterKey,onChange:this.updateNewTodo}),_react2.default.createElement("span",{className:"input-group-btn"},_react2.default.createElement("button",{type:"button",className:"btn btn-primary",value:this.state.newTodo,onClick:this.onAddNewButtonClick},_react2.default.createElement("span",{className:"glyphicon glyphicon-plus"}))))));},updateNewTodo:function updateNewTodo(evt){this.setState({newTodo:evt.target.value});},onAddNewButtonClick:function onAddNewButtonClick(evt){this.props.onAddNewButtonClick(this.state.newTodo);this.setState({newTodo:""});},onPressEnterKey:function onPressEnterKey(evt){if(evt.key==="Enter")this.onAddNewButtonClick();}});exports.default=TodoNew;},function(module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _react=__webpack_require__(1);var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
var TodoSelector=_react2.default.createClass({displayName:"TodoSelector",getInitialState:function getInitialState(){return{selectors:["All","Complete","Incomplete"]};},render:function render(){var _this=this;return _react2.default.createElement("div",{className:"row bottom-buffer"},_react2.default.createElement("ul",{className:"nav nav-tabs"},this.state.selectors.map(function(selectors,i){if(i==_this.props.selector)return _react2.default.createElement("li",{role:"presentation",className:"active",key:i},_react2.default.createElement("a",{onClick:function onClick(evt){return _this.props.onUpdateSelector(i);}},selectors,"\xA0",_react2.default.createElement("span",{className:"badge"},_this.countItems(_this.props.todos,i))));else return _react2.default.createElement("li",{role:"presentation",key:i},_react2.default.createElement("a",{onClick:function onClick(evt){return _this.props.onUpdateSelector(i);}},selectors,"\xA0",_react2.default.createElement("span",{className:"badge"},_this.countItems(_this.props.todos,i))));})));},countItems:function countItems(todoItems,i){var itemCounts=[0,0,0];itemCounts[0]=todoItems.length;for(var j=0;j<itemCounts[0];j++){if(this.props.todos[j].completed)itemCounts[1]++;else itemCounts[2]++;}
return itemCounts[i];}});exports.default=TodoSelector;}]);
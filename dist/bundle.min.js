...
var TodoList=_react2.default.createClass({displayName:"TodoList",render:function render(){var _this=this;return _react2.default.createElement("div",{className:"row bottom-buffer-list"},_react2.default.createElement("div",{className:" bottom-buffer-list"},this.props.todos.map(function(todo,i){if(todo.completed&&[0,1].includes(_this.props.selector))return _this.createList(todo,i);else if(!todo.completed&&[0,2].includes(_this.props.selector))return _this.createList(todo,i);})));},createList:function createList(todo,i){var _this2=this;return _react2.default.createElement("div",{className:"col-xs-12 half-buffer",key:i},_react2.default.createElement("div",{className:"input-group"},_react2.default.createElement("span",{className:"input-group-btn"},_react2.default.createElement("button",{type:"button",className:"btn btn-primary",onClick:function onClick(){return _this2.props.onComplete(i);}},_react2.default.createElement("span",{className:todo.completed?"glyphicon glyphicon-ok":"glyphicon glyphicon-none"}))),_react2.default.createElement("input",{type:"text",className:"form-control",onChange:function onChange(evt){return _this2.props.onUpdateText(i,evt.target.value);},value:todo.text}),_react2.default.createElement("span",{className:"input-group-btn"},_react2.default.createElement("button",{type:"button",className:"btn btn-danger",onClick:function onClick(){return _this2.props.onDelete(i);}},_react2.default.createElement("span",{className:"glyphicon glyphicon-trash"})))));}});exports.default=TodoList;},function(module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _react=__webpack_require__(1);var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
var TodoNew=_react2.default.createClass({displayName:"TodoNew",getInitialState:function getInitialState(){return{newTodo:""};},render:function render(){return _react2.default.createElement("div",{className:"row"},_react2.default.createElement("div",{className:"col-xs-12 navbar-fixed-bottom bottom-buffer"},_react2.default.createElement("hr",null),_react2.default.createElement("div",{className:"input-group"},_react2.default.createElement("input",{type:"text",className:"form-control",placeholder:"Add Something New",value:this.state.newTodo,onKeyPress:this.onPressEnterKey,onChange:this.updateNewTodo}),_react2.default.createElement("span",{className:"input-group-btn"},_react2.default.createElement("button",{type:"button",className:"btn btn-primary",value:this.state.newTodo,onClick:this.onAddNewButtonClick},_react2.default.createElement("span",{className:"glyphicon glyphicon-plus"}))))));},updateNewTodo:function updateNewTodo(evt){this.setState({newTodo:evt.target.value});},onAddNewButtonClick:function onAddNewButtonClick(evt){this.props.onAddNewButtonClick(this.state.newTodo);this.setState({newTodo:""});},onPressEnterKey:function onPressEnterKey(evt){if(evt.key==="Enter"){this.onAddNewButtonClick();}}});exports.default=TodoNew;},function(module,exports,__webpack_require__){"use strict";Object.defineProperty(exports,"__esModule",{value:true});var _react=__webpack_require__(1);var _react2=_interopRequireDefault(_react);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
